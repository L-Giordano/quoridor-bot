...
def create_wall(path,o_wall_graph,p_wall_graph,o_data,p_data):
    ...
    edges_to_rm=edges_to_remove(from_row,from_col,to_row,to_col,orientation)

    response=remove_egde(o_wall_graph,p_wall_graph,o_data,p_data,edges_to_rm)
...
def edges_to_remove(from_row,from_col,to_row,to_col,orientation):
    ...
    response=[]
    if orientation=='s':
        response.append(((from_row,from_col),(to_row,to_col)))#wall to the south
        response.append(((from_row,from_col-1),(to_row,to_col-1)))#wall to the south-west
        response.append(((from_row,from_col+1),(to_row,to_col+1)))#wall to the south-east
                        
        return response

    if orientation=='n':
        response.append(((to_row,to_col),(from_row,from_col)))#wall to the north
        response.append(((to_row,to_col-1),(from_row,from_col-1))) #wall to the north-west
        response.append(((to_row,to_col+1),(from_row,from_col+1))) #wall to the north-east
                        
        return response

    if orientation=='e':
        response.append(((from_row,from_col),(to_row,to_col))) #wall to the east
        response.append(((from_row-1,from_col),(to_row-1,to_col))) #wall to the north-east
        response.append(((from_row+1,from_col),(to_row+1,to_col))) #wall to the south-east
                        
        return response

    if orientation=='w':
        response.append(((to_row,to_col),(from_row,from_col))) #wall to the west
        response.append(((to_row-1,to_col),(from_row-1,from_col))) #wall to the south-west
        response.append(((to_row+1,to_col),(from_row+1,from_col))) #wall to the north-west
